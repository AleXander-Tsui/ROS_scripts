...
def save_image(num):
    ...
    img_file_path = "/home/tsui/Data/image_and_pose/" + str(num) + ".jpg"
...
def save_pose(num):
    odom = rospy.wait_for_message(
            ...
            Odometry)
    # Decode to cv2 image and store
    img_file_path = "/home/tsui/Data/image_and_pose/" + str(num) + ".txt"
...
if __name__=="__main__":
    ...
    while(1):
        ...
        if key in moveBindings.keys():
            ...
            save_image(num)
            save_pose(num)
            #rospy.Subscriber("/odom", Odometry, save_pose)
